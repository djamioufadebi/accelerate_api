          ...
          <div class="card aos-init aos-animate">
            <div class="flex-wrap card-header d-flex justify-content-between align-items-center">
              <div class="header-title">
                ...
                <p class="mb-0">Factures établies</p>
              </div>
            ...
            <div class="card-header pb-4 border-0">
              <div class="p-4 primary-gradient-card rounded border border-white">
                <div class="d-flex justify-content-between align-items-center">
                  <div>
                    <h5 class="font-weight-bold">CARTE CLIENT</h5>
                ...
                <div class="d-flex align-items-center mb-2 justify-content-between">
                  ...
                  <p class="mb-0">DATE D'EXPIRATION</p>
                </div>
                <div class="d-flex align-items-center justify-content-between">
                  <h6>Vianney </h6>
                  <h6 class="ms-5">12/30</h6>
                </div>
              </div>
            </div>
            <div class="card-body">
              <div class="d-flex align-itmes-center flex-wrap mb-4">
                <div class="d-flex align-itmes-center me-0 me-md-4">
                  ...
                  <div class="ms-3">
                    <h5>5 000</h5>
                    <small class="mb-0">Factures</small>
                  </div>
                </div>
                <div class="d-flex align-itmes-center">
                  ...
                  <div class="ms-3">
                    <h5>1 500</h5>
                    <small class="mb-0">Clients</small>
                  </div>
                </div>
              </div>
              <div class="mb-4">
              ...
              <div class="d-grid grid-cols-2 gap">
                <button class="btn btn-primary text-uppercase p-2">Factures</button>
                <button class="btn btn-info text-uppercase p-2">Clients</button>
              </div>
            </div>
          </div>
  ...
  setup() {
    ...
    const grossSaleChart = ref({
      ...
      options: {
        ...
        xaxis: {
          ...
          categories: ['Janvier', 'Fevrier', 'Mars', 'Avril', 'Juin', 'Jullet', 'Août']
        },
        grid: {
          show: false
        },
    ...
    const swiperItems = ref([
      ...
      },
      {
        size: 70,
        amount: '375K',
        subTitle: 'Total montant factures',
        color: 'primary'
      },
      {
        size: 60,
