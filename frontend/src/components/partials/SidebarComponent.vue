<template>
  ...
  <default-sidebar>
    <ul class="navbar-nav iq-main-menu" id="sidebar-menu">
      <side-menu title="Accueil" :static-item="true"></side-menu>
      <side-menu isTag="router-link" title="Tableau de bord" icon="view-grid" :route="{ to: 'default.dashboard' }"></side-menu>
