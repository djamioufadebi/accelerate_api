                ...
                <div class="p-0">
                  <ul class="list-group list-group-flush p-0">
                    <li class="iq-sub-card list-group-item">
                      <a class="p-0" href="#"><img src="@/assets/images/Flag/flag-03.png" alt="img-flaf" class="img-fluid me-2" style="width: 15px; height: 15px; min-width: 15px" />Espagnol</a>
                    </li>
                    <li class="iq-sub-card list-group-item">
                      <a class="p-0" href="#"><img src="@/assets/images/Flag/flag-04.png" alt="img-flaf" class="img-fluid me-2" style="width: 15px; height: 15px; min-width: 15px" />Italien</a>
                    </li>
                    <li class="iq-sub-card list-group-item">
                      <a class="p-0" href="#"><img src="@/assets/images/Flag/flag001.png" alt="img-flaf" class="img-fluid me-2" style="width: 15px; height: 15px; min-width: 15px" />Anglais</a>
                    </li>
                  </ul>
                </div>
              </b-card>
                ...
                <b-card-body class="p-0">
                  <a href="#" class="iq-sub-card">
                    <div class="d-flex align-items-center">
                      ...
                      <div class="ms-3 w-100">
                        <h6 class="mb-0">Vous avez 2 factures non réglés</h6>
                  ...
                  <a href="#" class="iq-sub-card">
                    <div class="d-flex align-items-center">
                      ...
                      <div class="ms-3 w-100">
                        <h6 class="mb-0">Veuillez régler votre abonnement du mois</h6>
                        <!-- <div class="d-flex justify-content-between align-items-center">
            ...
            <ul class="dropdown-menu dropdown-menu-end" aria-labelledby="navbarDropdown">
              <li>
                <router-link class="dropdown-item" :to="{ name: 'default.user-profile' }">
                  <icon-component type="dual-tone" icon-name="user"></icon-component> Profile
                </router-link>
              </li>
